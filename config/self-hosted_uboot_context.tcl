...
#
# This file implements lowest layer operations without the real VL - all
# operations on the target device are perfomed directly from the host, or
	...
	if [is_powered_on] {
		if {$cur_context == "kernel"} {
			...
			if ![_context_kernel_get_prompt] {
				p_err "could not get kernel prompt" 1
			}
